<?php 	
	...
	session_start();
		...
		switch ($_SESSION['choix']) {
			case 'create' : $action = '../controleur/actionFinaleProduit.php'; break;
			case 'read'   : $action = '../controleur/readProduit.php'; break;
			case 'update' : $action = '../controleur/updateProduit.php'; break;
			case 'delete' : $action = '../controleur/updateProduit.php'; break;
		};
